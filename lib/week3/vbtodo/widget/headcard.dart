...
import 'package:design/week3/vbtodo/todo/vbtodo_view.dart';
import 'package:flutter/material.dart';

class HeaderCard extends StatelessWidget with ImageConstants {
  final String title;
  ...
  HeaderCard({Key key, this.title, this.decripiton, this.image})
      : super(key: key);
  @override
  ...
  ClipRRect buildClipRRectBackgroundImage() =>
      ClipRRect(borderRadius: BorderRadius.circular(20), child: buildImage());
  ...
  Text buildTextTitle(BuildContext context) {
    return Text(title,
        style: theme(context).textTheme.headline3.copyWith(
            fontWeight: FontWeight.bold, color: theme(context).canvasColor));
  }

  H4CustomText buildH4customTextDescription() =>
      H4CustomText(title: decripiton);
}
